...
\paragraph{Einschub: Clement-Operator}
...
Betrachte dazu eine quasi-uniforme Triangulierung $\cT_{h}$, dann ergibt die obige Konstruktion einen Fortin-Interpolator.
